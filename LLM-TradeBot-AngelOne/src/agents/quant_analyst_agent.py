"""
The Strategist (Quant Analyst Agent) - Refactored Version

Responsibilities:
Organize technical analysis by time period, not by indicator type
- 6-hour analysis: Complete technical indicator set
- 2-hour analysis: Complete technical indicator set
- 30-minute analysis: Complete technical indicator set

Optimizations:
- Time period-centric organization
- Easier for LLM to understand complete technical picture per timeframe
- Extended indicator set: EMA, MA, BOLL, RSI, MACD, KDJ, ATR, OBV
"""
...
class QuantAnalystAgent:
    """
    The Strategist (Quant Analyst Agent)
    
    Provides sentiment analysis and OI fuel verification
    Technical indicator analysis now uses real 1h/15m/5m data directly in main.py
    """
    ...
    async def analyze_all_timeframes(self, snapshot: MarketSnapshot) -> Dict:
        ...
        # 6. Market regime detection (Using 1h for backbone regime)
        ...
        result = {
            ...
            'regime': regime,
            # Keep empty placeholders for compatibility
            'timeframe_6h': {}, 
            'timeframe_2h': {},
            'timeframe_30m': {},
