...
Generate HTML format backtest reports
...
class BacktestReport:
    ...
    Generate HTML reports containing:
    1. Performance metrics summary
    2. Equity curve chart
    3. Drawdown curve chart
    4. Monthly returns heatmap
    5. Trade details table
    """
    ...
    def generate(
        ...
        Args:
            metrics: Performance metrics result
    ...
    <div class="container">
        ...
        <div class="grid">
            <div class="card">
                ...
                <div class="metric">
                    <span class="metric-label">Drawdown Recovery</span>
                    <span class="metric-value">{metrics.max_drawdown_duration} days</span>
                </div>
            </div>
